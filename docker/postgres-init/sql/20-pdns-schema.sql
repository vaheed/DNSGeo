...
GRANT CONNECT ON DATABASE pdns TO pdns, poweradmin;
GRANT USAGE, CREATE ON SCHEMA public TO pdns, poweradmin;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO pdns, poweradmin;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA public TO pdns, poweradmin;

ALTER DEFAULT PRIVILEGES FOR ROLE pdns IN SCHEMA public
